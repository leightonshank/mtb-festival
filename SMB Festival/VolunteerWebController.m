...
@implementation VolunteerWebController
@synthesize web;
@synthesize loading;
...
- (void)loadPage {
    ...
    NSURL *htmlURL = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"volunteer" ofType:@"html"]];
